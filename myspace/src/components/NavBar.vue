<template>
  ...
  <div class="container">
    <router-link class="navbar-brand" :to="{name:'home'}">棋社</router-link>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <router-link class="nav-link " :to="{name:'login'}">用户列表</router-link>
          </li>
          </ul>
        ...
        <li class="nav-item">
          <ul class="navbar-nav " v-if="!$store.state.user.is_login">
          <li class="nav-item">
            <router-link class="nav-link " :to="{name:'login'}">棋局</router-link>
          </li>
          </ul>
          <ul class="navbar-nav " v-else>
          <router-link class="nav-link" :to="{name:'chess'}">棋局</router-link>
          </ul>
        </li>
        <li class="nav-item">
          <ul class="navbar-nav " v-if="!$store.state.user.is_login">
          <li class="nav-item">
            <router-link class="nav-link " :to="{name:'login'}">棋局列表</router-link>
          </li>
          </ul>
          <ul class="navbar-nav " v-else>
          <router-link class="nav-link" :to="{name:'chesslist'}">棋局列表</router-link>
          </ul>
        </li>
       <!--<li class="nav-item">
